...
Future<void> main() async {
  ...
  var refused = false;
  try {
    final unexpected = await Socket.connect(InternetAddress.loopbackIPv4, unusedPort, timeout: const Duration(seconds: 2));
    unexpected.destroy();
  } on SocketException {
    refused = true;
  }
  ...
  stdout.writeln('F006_DART_SOCKET_PASS truncated_eof_rejected=true connect_failure_observed=true bidirectional_teardown=true');
