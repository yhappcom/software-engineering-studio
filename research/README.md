...
- `M003` — runtime dangerous-permission grant/revoke transfer validated. Android Keystore process/tamper transfer has one bounded TRANSFER VALIDATION PASS at exact head `0ea436129fa150b578c777abf1ac6a6500b84a4e`, run `35538756528` attempt 1, job `106152447185`. Same-head attempt 2, job `106160817014`, failed at the explicit `first launch` diagnostic verdict after build/setup succeeded; later semantic phases were skipped. **REPLICATION is not awarded.** Together with the earlier first-launch-adjacent failure this reproduces the observation failure class but not its root cause. Hardware-backed/StrongBox, auth-bound keys, physical device, backup/restore, iOS and product transfer remain OPEN. Canonical: `research/mobile/M003_android_keystore_secure_storage_transfer.md`.
