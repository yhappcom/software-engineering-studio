...
- `M003` — runtime dangerous-permission grant/revoke transfer validated. Android Keystore process/tamper semantics now have bounded REPLICATION at API-35 emulator scope: initial complete PASS at exact head `0ea436129fa150b578c777abf1ac6a6500b84a4e`, run `35538756528` attempt 1, job `106152447185`, followed by intervening first-launch-adjacent failures, then a second complete semantic execution at exact head `8163960e333751df91f4dc639c59590f23eea1e8`, run `35557564657`, job `106204067727`. The latter preserves key/crypto/ciphertext/recovery/tamper semantics while adding independent phase markers and metadata-visible failure verdicts. Intermittent first-launch ROOT CAUSE remains OPEN; physical/hardware-backed/iOS/product security claims remain OPEN. User-driven permission-dialog transfer is now IN STUDY at exact head `63f96e010691db87fea13bc7e08866c082dfb656`, run `35564720878`: actual Android system `Only this time` and denial controls are exercised without shell grant/revoke; no PASS until terminal evidence. Canonical: `research/mobile/M003_android_keystore_secure_storage_transfer.md`, `research/mobile/M003_first_launch_observation_isolation.md`, `research/mobile/M003_keystore_semantic_first_launch_instrumentation.md`, `research/mobile/M003_android_user_permission_dialog_transfer.md`.
