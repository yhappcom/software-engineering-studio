...
### Architecture
- `A001` — `research/architecture/A001_information_hiding_change_pressure.md` — **IN STUDY**. Parnas-style information hiding/change-pressure model established; executable representation-change fixture demonstrates bounded change locality and deliberate failure from duplicated representation knowledge. Counterexample/transfer validation remain OPEN.
