...
- `M003` — runtime dangerous-permission grant/revoke transfer validated. Android Keystore process/tamper transfer has one bounded TRANSFER VALIDATION PASS at exact head `0ea436129fa150b578c777abf1ac6a6500b84a4e`, run `35538756528` attempt 1, job `106152447185`; same-head attempt 2 failed at first launch, so semantic REPLICATION is not awarded. Independent simplified startup isolation passed but did not identify root cause because it removed Keystore/AES-GCM semantics. The original semantic target is now instrumented at exact head `d6641234713784620fd6bcfe8e6c12e519b33c87` with independent process/Activity/native-result/UI-publication/resume/UI-automation markers while preserving key/crypto/ciphertext/recovery/tamper semantics; run `35554495251` is pending. Canonical: `research/mobile/M003_android_keystore_secure_storage_transfer.md`, `research/mobile/M003_first_launch_observation_isolation.md`, `research/mobile/M003_keystore_semantic_first_launch_instrumentation.md`. ROOT CAUSE and semantic REPLICATION remain OPEN pending terminal evidence.
