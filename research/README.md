...
- `M003` — runtime dangerous-permission grant/revoke transfer validated. Android Keystore process/tamper transfer has one bounded TRANSFER VALIDATION PASS at exact head `0ea436129fa150b578c777abf1ac6a6500b84a4e`, run `35538756528` attempt 1, job `106152447185`; same-head attempt 2 failed at first launch, so semantic REPLICATION is not awarded. Independent startup isolation at exact head `282f3032a6c743fb26cb094aeff89da3b67d918e`, run `35547919604`, job `106177104878` completed success: package process, Activity entry, trivial native completion, UI publication/resume and UI-automation observation can all succeed in the simplified API-35 fixture. This falsifies an infrastructure-wide deterministic startup-observation failure but does not establish the original Keystore ROOT CAUSE because Keystore/AES-GCM semantics were removed. Canonical: `research/mobile/M003_android_keystore_secure_storage_transfer.md`, `research/mobile/M003_first_launch_observation_isolation.md`. Hardware-backed/StrongBox, auth-bound keys, physical device, backup/restore, iOS and product transfer remain OPEN.
