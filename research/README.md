...
- `D005` — `research/data/D005_backup_restore_recovery_acceptance.md` — **IN STUDY / first integrated backup-restore block complete**. Actual isolated restore + physical/schema/semantic acceptance, corrupt-artifact failure, and physically-valid-but-contract-incompatible failure evidence. Restore publication/interruption and mobile behavior remain OPEN.
