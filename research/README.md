...
- `M003` — runtime dangerous-permission shell grant/revoke transfer validated. Android Keystore process/tamper semantics have bounded REPLICATION at API-35 emulator scope: initial complete PASS at exact head `0ea436129fa150b578c777abf1ac6a6500b84a4e`, run `35538756528`, job `106152447185`, followed by intervening first-launch-adjacent failures, then second complete semantic execution at exact head `8163960e333751df91f4dc639c59590f23eea1e8`, run `35557564657`, job `106204067727`; intermittent first-launch ROOT CAUSE remains OPEN. User-driven permission-dialog transfer has bounded TRANSFER VALIDATION at exact head `6fda0223249e723f2b9ee636a7329a97ec64b697`, run `35589277729`, job `106299744861`, Flutter 3.47.5 + API-35 x86_64 Pixel 6 emulator. Repeated-denial/`USER_FIXED` lifecycle has bounded TRANSFER VALIDATION at exact head `5c088398f9f527b96b0da926b26e5aa77d9de000`, run `35619492437`, job `106398675688`. One-time ordinary-background expiry has bounded TRANSFER VALIDATION at exact head `ae5597cc15fca07fcc63688a91f1cf8da9ac15f4`, run `35662745671`, artifact `10667827225`: grant remained through 55.4s after HOME and was revoked at 60.4s, followed by re-requestability; 60.4s is an observation, not a portable timeout contract. The foreground-service causal branch now has bounded TRANSFER VALIDATION for the held-authority subclaim at exact head `3d948ef0c3cf63500aa840eebf0591d0df54c1bd`, run `35679723145`, artifact `10674236432`: one-time CAMERA authority, PID and camera FGS state survived the full 90-second HOME hold. Post-stop expiry/requestability remains OPEN because run 2 failed at the shell-controlled stop transition. Exact head `5eaa1eeec4e6e99d3236a3e71d9957e544636b00` replaces that external shell stop with an app-owned acknowledged `stopService` transition; run `35687049739` is the pending validation target. Independent physical/OEM/other-API replication, auto-reset/hibernation, iOS/product/production remain OPEN. Canonical includes `research/mobile/M003_android_keystore_secure_storage_transfer.md`, `research/mobile/M003_first_launch_observation_isolation.md`, `research/mobile/M003_keystore_semantic_first_launch_instrumentation.md`, `research/mobile/M003_android_user_permission_dialog_transfer.md`, `research/mobile/M003_android_repeated_denial_user_fixed_lifecycle.md`, `research/mobile/M003_one_time_permission_expiry_background_boundary.md`, `research/mobile/M003_one_time_permission_foreground_service_discriminator.md`, and `research/mobile/M003_fgs_discriminator_run2_evidence.md`.
