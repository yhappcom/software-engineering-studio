...
- `M003` — runtime dangerous-permission grant/revoke transfer validated. New Android Keystore secure-storage transfer is **PENDING** at exact workflow head `ed092abb3c81f4c47007499cd86edfd8cf6036cb`, run `35535674389`: AES-256/GCM AndroidKeyStore key non-exportability through `SecretKey.encoded`, fresh-process ciphertext recovery, external ciphertext mutation and authenticated-decryption rejection are required before PASS. Hardware-backed/StrongBox, auth-bound keys, physical device, backup/restore, iOS and product transfer remain OPEN. Canonical: `research/mobile/M003_android_keystore_secure_storage_transfer.md`.
